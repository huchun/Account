...
public  class LoginRequest extends BaseRequest{
	...
	public static String Access = HttpService.LOGIN;
         	    ...
         	    try {
         	    	...
         	    	if(response.getInt("response_code")==0){
             	    	...
             	    	switch(JsonObject.getInt("apiStatus")){
                 	    	case 0:         	    		
                        		listener.loadSuccess(LoginRequest.this);
                        		AccountType.getInstance().token = user.optString("ticket");             
                        		AccountType.getInstance().userId = user.getLong("userId");
                 	    		break;
                 	    	case 1:
                        		errorStringId=BaseRequest.noexists;
                        		listener.loadFailure(LoginRequest.this);
                 	    		break;
                 	    	case 2:
                        		errorStringId=BaseRequest.passError;
                        		listener.loadFailure(LoginRequest.this);
                 	    		break;
             	    		default:
             	    			break;	
                		...
                		errorStringId=BaseRequest.devicemore;
                		listener.loadFailure(LoginRequest.this);
         	    	}
